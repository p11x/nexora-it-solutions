...
export const testimonials = [
  {
    ...
    initials: 'SC',
    text: 'Nexora transformed our legacy infrastructure into a modern cloud-native platform. Their team delivered on time, on budget, and exceeded every technical benchmark.',
    rating: 5,
  },
  {
    ...
    initials: 'MR',
    text: 'The AI solutions Nexora built increased our operational efficiency by 40%. Their deep expertise in ML and custom software is unmatched.',
    rating: 5,
  },
  {
    name: 'Emily Nakamura',
    ...
    initials: 'EN',
    text: 'Their cybersecurity audit uncovered critical vulnerabilities we had missed for years. Nexora is now our permanent security partner for all infrastructure needs.',
    rating: 5,
  },
]
...
export const team = [
  {
    name: 'David Park',
    role: 'CEO & Founder',
    bio: '20+ years in enterprise IT architecture. Former Chief Architect at a Fortune 500 cloud provider. Driving Nexora\'s vision of accessible, enterprise-grade innovation.',
    initials: 'DP',
    color: '#6366f1',
  },
  {
